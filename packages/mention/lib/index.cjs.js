...
function addMention(
  ...
  var mentionReplacedContent = draftJs.Modifier.replaceText(
  ...
  if (blockSize === end) {
    mentionReplacedContent = draftJs.Modifier.insertText(
...
MentionSuggestions.propTypes = {
  ...
  entityMutability: PropTypes__default['default'].oneOf([
    'SEGMENTED',
    'IMMUTABLE',
    'MUTABLE',
  ]),
